...
| 2026-09-03 | community | GitHub stars / forks / open issues-or-PRs | 0 / 0 / 6 | GitHub repository API snapshot, TechCodinz/CKB, captured 2026-09-03 | Yes | Unchanged from 2026-09-02; recorded for continuity, not as a growth milestone. |
| 2026-09-03 | technical contribution | Gemini 3.8 Flash capability profile merged | PR #28 merged as a8ee737569c3b15826402ca6dc41685f2f528797 | TechCodinz/CKB PR #28 and merge commit | No | Adds a source-backed Gemini 3.8 Flash profile and registry coverage. This is internal implementation evidence, not deployment, adoption or independent recognition. |
| 2026-09-03 | quality blocker | Post-merge review found raw GenerateContent constraint-normalization gap | P2 review finding on merged PR #28 | TechCodinz/CKB PR #28 review comment 3925150608, captured 2026-09-03 | No | Raw GenerateContent payloads nest camelCase controls under generationConfig while the adapter validates top-level snake_case/literal paths; the review reports that unsupported candidateCount or thinkingLevel=minimal can therefore pass through as compatible. No later CKB commit was present in this capture to verify a fix. |
| 2026-09-03 | distribution status | VS Code Marketplace metrics/publication verification | unavailable in this capture | Microsoft Visual Studio Marketplace exact public searches for `TechCodinz.ckb-vscode`, captured 2026-09-03 | Yes | Exact searches again did not surface the CKB extension listing. Install/download count, web/download count, rating average/count, version and publication/update timestamps remain unavailable; unavailable values are not converted to zero and v1.10.2 remains unverified as Marketplace-published. |
